...
namespace tsMuxerJoin.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Selected directory doesn&apos;t have supported files.
        /// </summary>
        internal static string dirHasNoSupportedFiles {
            get {
                return ResourceManager.GetString("dirHasNoSupportedFiles", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string exeHint {
            get {
                return ResourceManager.GetString("exeHint", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Failed to launch muxer process.
        /// </summary>
        internal static string muxerExecFailed {
            get {
                return ResourceManager.GetString("muxerExecFailed", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Muxer process exited with code {0}.
        /// </summary>
        internal static string muxerFailed {
            get {
                return ResourceManager.GetString("muxerFailed", resourceCulture);
            }
        }
